...
class IncomeServiceRepositoryEloquentTest extends ApiTestCase
{
    ...
    {
        $incomeService = $this->prepareIncomeService();
        $fundStructure = $this->createFundStructure($incomeService->id);
    ...
    {
        $fundItemsStructure = $this->createFundItemStructure();
    ...
    public function it_creates_denomination_structures()
    {
        ...
        $denominationStructure = $this->createDenominationStructure($incomeService->id);
     ...
     * @return array
     */
    private function createFundStructure($incomeServiceId)
    {
     ...
     * @return array
     */
    private function createFundItemStructure()
    {
        $incomeService = $this->prepareIncomeService();
     ...
     * @return array
     */
    private function createDenominationStructure($incomeServiceId)
    {
